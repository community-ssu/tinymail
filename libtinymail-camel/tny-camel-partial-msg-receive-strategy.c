...
{
	return TNY_CAMEL_PARTIAL_MSG_RECEIVE_STRATEGY_GET_CLASS (self)->perform_get_msg(self, folder, header, err);
}
...
{
	klass->perform_get_msg= tny_camel_partial_msg_receive_strategy_perform_get_msg;
}
...
tny_camel_partial_msg_receive_strategy_class_init (TnyCamelPartialMsgReceiveStrategyClass *klass)
{
	...
	klass->perform_get_msg= tny_camel_partial_msg_receive_strategy_perform_get_msg_default;
