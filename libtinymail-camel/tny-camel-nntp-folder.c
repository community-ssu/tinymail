...
/* TODO: Refactor to a TnyNNTPStoreAccount, TnyNNTPStoreAccount and 
...
static void 
tny_camel_nntp_folder_class_init (TnyCamelNNTPFolderClass *class)
{
	...
	TNY_CAMEL_FOLDER_CLASS (class)->remove_folder= tny_camel_nntp_folder_remove_folder;
	TNY_CAMEL_FOLDER_CLASS (class)->create_folder= tny_camel_nntp_folder_create_folder;
...
static void
tny_camel_nntp_folder_instance_init (GTypeInstance *instance, gpointer g_class)
{
	return;
}
