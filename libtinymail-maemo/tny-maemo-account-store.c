...
static gboolean
tny_maemo_account_store_alert (TnyAccountStore *self, TnyAccount *account, TnyAlertType type, gboolean question, GError *error)
{
...
tny_account_store_init (gpointer g, gpointer iface_data)
{
	...
	klass->get_accounts= tny_maemo_account_store_get_accounts;
	klass->get_cache_dir= tny_maemo_account_store_get_cache_dir;
	klass->get_device= tny_maemo_account_store_get_device;
	klass->alert= tny_maemo_account_store_alert;
	klass->find_account= tny_maemo_account_store_find_account;
